...
import week6.competition.AliBeratTopcuAI;
import week6.competition.DmitriAI;
import week6.competition.Egemen;
import week6.competition.FurkanGencerAI;
...
public class MasterMind {
    ...
    private void playOneTurn() {
        ...
        Digits guess = Digits.fromInt( p.makeAGuess().toInt());
        ...
        turn++;
        isRoundOver = isRoundOver || turn>maxTurnCount;
    ...
    public static void main(String[] args) {
        ...
        mm.addPlayer(new FurkanGencerAI());
        mm.addPlayer(new Egemen());
        mm.addPlayer(new DmitriAI());
        mm.addPlayer(new R2D2());
        mm.addPlayer(new AliBeratTopcuAI());
